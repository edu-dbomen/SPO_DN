...
impl Registers {
    ...
    pub fn get_s(&self) -> i32 { self.s }
    pub fn get_t(&self) -> i32 { self.t }
    pub fn get_f(&self) -> f64 { self.f }
    pub fn get_pc(&self) -> i32 { self.pc }
    pub fn get_sw(&self) -> i32 { self.sw }

    pub fn set_a(&mut self, val: i32) -> () { self.a = val; }
    pub fn set_x(&mut self, val: i32) -> () { self.x = val; }
    pub fn set_l(&mut self, val: i32) -> () { self.l = val; }
    pub fn set_b(&mut self, val: i32) -> () { self.b = val; }
    pub fn set_s(&mut self, val: i32) -> () { self.s = val; }
    pub fn set_t(&mut self, val: i32) -> () { self.t = val; }
    pub fn set_f(&mut self, val: f64) -> () { self.f = val; }
    pub fn set_pc(&mut self, val: i32) -> () { self.pc = val; }
    pub fn set_sw(&mut self, val: i32) -> () { self.sw = val; }
